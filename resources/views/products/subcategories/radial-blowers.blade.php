            ...
            <div class="flex flex-col md:flex-row">
                <div class="w-full md:w-2/3">
                    ...
                    <p class="mb-8 leading-relaxed text-gray-700">
                        Radial blowers are designed for high delivery volumes. The volume flow can be precisely adapted to
                        customer requirements
                        using the frequency inverter integrated on the motor.
                    ...
                    <p class="mb-8 leading-relaxed text-gray-700">
                        Radial blowers contain a very fast and contactless rotating impeller and are therefore wear and
                        maintenance free.
                ...
                <div class="w-full md:w-1/3 mt-4 md:mt-0 flex items-center">
                    <a href="https://www.youtube.com/embed/46y1-Eo3rE" class="venobox" data-vbtype="video">
                        <img src="{{ asset('images/Becker_Operating_principle_of_radial_blowers_Thumbnail.webp') }}"
