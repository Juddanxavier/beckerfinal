...
<section class="py-24 bg-gray-100" data-aos="fade-up">
    <div class="container mx-auto px-4 max-w-screen-xl">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-16 items-center">
            ...
            <div class="md:col-span-2 text-md text-gray-700 leading-relaxed" data-aos="fade-up" data-aos-delay="100">
                <h2 class="text-4xl md:text-4xl mb-6">Premium Service</h2>
                <p class="mb-6">
